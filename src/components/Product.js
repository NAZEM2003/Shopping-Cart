        ...
        <div className={styles.container}>
            ...
            <div>
                ...
                <div  className={styles.linkContainer}>
                    ...
                    <Link to={`/datails/${productData.id}`}>Details</Link>

                    <div className={styles.buttonContainer}>

                    {
                        quantityCount(state , productData.id) === 1 && <button className={styles.smallButton} onClick={()=> dispatch({type : 'REMOVE_ITEM' , payload : productData})}><i className='fa fa-trash'></i></button>
                    }
                    {
